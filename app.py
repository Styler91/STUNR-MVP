...
st.image("stunr_logo.png", width=200)  # Add your logo here (save as stunr_logo.png in the same folder)
...
# Note: Streamlit Cloud might not save CSV files locally; we'll adjust later if needed